unit Relacao_Vendas_Manutencao_02;
...
type
  TVendasManutencao02 = class(TForm)
    Panel1: TPanel;
    GroupBox1: TGroupBox;
    Label2: TLabel;
...
var
  VendasManutencao02: TVendasManutencao02;

implementation

uses Conexao_BD, Rotinas_Gerais, GifUnit;
...
function TVendasManutencao02.Valida_Dados(): Boolean;
...
function TVendasManutencao02.CurrText: TJvTextAttributes;
begin
     Result := Venda_Manutencao_Descricao.SelAttributes;
end;

procedure TVendasManutencao02.FormCreate(Sender: TObject);
begin
     SetupRuler;
end;

procedure TVendasManutencao02.BT_Edita_FonteClick(Sender: TObject);
begin
...
procedure TVendasManutencao02.BT_Insere_ImagemClick(Sender: TObject);
...
procedure TVendasManutencao02.BT_Insere_RtfClick(Sender: TObject);
begin
...
procedure TVendasManutencao02.BT_Alinha_EsquerdaClick(Sender: TObject);
begin
     Venda_Manutencao_Descricao.Paragraph.Alignment := TParaAlignment(0); // paLeftJustify;
end;

procedure TVendasManutencao02.BT_Alinha_CentroClick(Sender: TObject);
begin
     Venda_Manutencao_Descricao.Paragraph.Alignment := TParaAlignment(2); // paCenter
end;

procedure TVendasManutencao02.BT_JustificaClick(Sender: TObject);
begin
     Venda_Manutencao_Descricao.Paragraph.Alignment := TParaAlignment(3); // paJustify;
end;

procedure TVendasManutencao02.BT_Alinha_DireitaClick(Sender: TObject);
begin
     Venda_Manutencao_Descricao.Paragraph.Alignment := TParaAlignment(1); // paRightJustify
end;

procedure TVendasManutencao02.BT_Inserir_MarcadoresClick(Sender: TObject);
begin
...
procedure TVendasManutencao02.BT_Aumentar_RecuoClick(Sender: TObject);
begin
     Venda_Manutencao_Descricao.Paragraph.FirstIndent := Venda_Manutencao_Descricao.Paragraph.FirstIndent + 5;
end;

procedure TVendasManutencao02.BT_Diminuir_RecuoClick(Sender: TObject);
begin
...
procedure TVendasManutencao02.BT_ImprimirClick(Sender: TObject);
begin
...
procedure TVendasManutencao02.SelectionChange(Sender: TObject);
begin
...
procedure TVendasManutencao02.RulerResize(Sender: TObject);
begin
...
procedure TVendasManutencao02.RulerItemMouseDown(Sender: TObject; Button: TMouseButton;
...
procedure TVendasManutencao02.RulerItemMouseMove(Sender: TObject; Shift: TShiftState;
  X, Y: Integer);
begin
  if FDragging then
    TLabel(Sender).Left :=  TLabel(Sender).Left+X-FDragOfs
...
procedure TVendasManutencao02.FirstIndMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  FDragging := False;
...
procedure TVendasManutencao02.LeftIndMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  FDragging := False;
...
procedure TVendasManutencao02.RightIndMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  FDragging := False;
...
procedure TVendasManutencao02.Venda_Manutencao_DescricaoChange(Sender: TObject);
begin
  SetModified(Venda_Manutencao_Descricao.Modified);
end;

procedure TVendasManutencao02.SetupRuler;
var
  I: Integer;
  S: String;
begin
...
procedure TVendasManutencao02.UpdateCursorPos;
var
  CharPos: TPoint;
begin
...
procedure TVendasManutencao02.SetModified(Value: Boolean);
begin
  if Value then StatusBar.Panels[1].Text := sModified
  else StatusBar.Panels[1].Text := '';
end;

procedure TVendasManutencao02.BT_SairClick(Sender: TObject);
begin
     VendasManutencao02.close;
end;

procedure TVendasManutencao02.FormShow(Sender: TObject);
begin
     SetModified(False);
...
procedure TVendasManutencao02.Venda_Manutencao_ServicoKeyPress(
...
procedure TVendasManutencao02.Venda_Manutencao_TipoKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TVendasManutencao02.Venda_Manutencao_EntradaKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TVendasManutencao02.Venda_Manutencao_SaidaKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TVendasManutencao02.Venda_Manutencao_Relacao_PecasKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TVendasManutencao02.Venda_Manutencao_ValorKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TVendasManutencao02.BT_ExcluirClick(Sender: TObject);
begin
...
procedure TVendasManutencao02.BT_AlterarClick(Sender: TObject);
...
begin
     If Valida_Dados() Then
        ...
        //*** Efetua a checagem do campo Nro. caso Serviço igual a venda ***

          if Venda_Manutencao_Servico.text = 'Venda'  Then
            Begin
              Comando_SQL := 'Select * from vendas_manutencao where venda_manutencao_nro_equipamento = '+ #39 + trim(venda_manutencao_nro_equipamento.text)+ #39 +'  Order by venda_manutencao_nro_equipamento Desc';
              ...
              ConexaoBD.SQL_Vendas_Manutencao.Open;
               ...
               If ConexaoBD.SQL_Vendas_Manutencao.RecordCount > 0 Then
                 Begin
                    ...
                    Seta();
                    MSG_Erro('Nro. do Equipamento já existe...');
     ...
     If  NroEquip <> 'duplicado' then
      Begin
        ...
        Comando_SQL := 'Select * from vendas_manutencao Where venda_manutencao_numero = ' + Trim(Venda_Manutencao_Numero.Text);
...
procedure TVendasManutencao02.Venda_Manutencao_Nro_EquipamentoKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
