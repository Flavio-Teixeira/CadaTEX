     ...
     Else
        ...
        If Opcoes_Procura_Data.Text = 'Entrada' Then
           ...
           If Trim(Dados_Procura.Text) = '' Then
              ...
              If Trim(Opcoes_Procura_Servico.Text) = 'Todos' Then
                 ...
                 End
              Else If Trim(Opcoes_Procura_Servico.Text) = 'Cotação' Then
                 Begin
                 Comando_SQL       := 'Select * from Vendas_Manutencao, Clientes Where venda_manutencao_cliente_codigo = cliente_codigo And venda_manutencao_servico = ' + #39 + 'Cotação' + #39 + ' And (venda_manutencao_entrada >= #' + Inverte_Data_Plus(Trim(Data_Procura_Entrada.Text),'amd','-') + '# And venda_manutencao_entrada <= #' + Inverte_Data_Plus(Trim(Data_Procura_Saida.Text),'amd','-') + '#) Order By venda_manutencao_entrada Desc';
                 Comando_SQL_Total := 'Select Sum(venda_manutencao_valor) as venda_manutencao_total from Vendas_Manutencao, Clientes Where venda_manutencao_cliente_codigo = cliente_codigo And venda_manutencao_servico = ' + #39 + 'Cotação' + #39 + ' And (venda_manutencao_entrada >= #' + Inverte_Data_Plus(Trim(Data_Procura_Entrada.Text),'amd','-') + '# And venda_manutencao_entrada <= #' + Inverte_Data_Plus(Trim(Data_Procura_Saida.Text),'amd','-') + '#)';
                 End
              Else If Trim(Opcoes_Procura_Servico.Text) = 'Locação' Then
                 Begin
                 Comando_SQL       := 'Select * from Vendas_Manutencao, Clientes Where venda_manutencao_cliente_codigo = cliente_codigo And venda_manutencao_servico = ' + #39 + 'Locação' + #39 + ' And (venda_manutencao_entrada >= #' + Inverte_Data_Plus(Trim(Data_Procura_Entrada.Text),'amd','-') + '# And venda_manutencao_entrada <= #' + Inverte_Data_Plus(Trim(Data_Procura_Saida.Text),'amd','-') + '#) Order By venda_manutencao_entrada Desc';
                 Comando_SQL_Total := 'Select Sum(venda_manutencao_valor) as venda_manutencao_total from Vendas_Manutencao, Clientes Where venda_manutencao_cliente_codigo = cliente_codigo And venda_manutencao_servico = ' + #39 + 'Locação' + #39 + ' And (venda_manutencao_entrada >= #' + Inverte_Data_Plus(Trim(Data_Procura_Entrada.Text),'amd','-') + '# And venda_manutencao_entrada <= #' + Inverte_Data_Plus(Trim(Data_Procura_Saida.Text),'amd','-') + '#)';
                 End
              Else If Trim(Opcoes_Procura_Servico.Text) = 'Manutenção' Then
                 Begin
                 ...
                 Comando_SQL_Total := 'Select Sum(venda_manutencao_valor) as venda_manutencao_total from Vendas_Manutencao, Clientes Where venda_manutencao_cliente_codigo = cliente_codigo And venda_manutencao_servico = ' + #39 + 'Manutenção' + #39 + ' And (venda_manutencao_entrada >= #' + Inverte_Data_Plus(Trim(Data_Procura_Entrada.Text),'amd','-') + '# And venda_manutencao_entrada <= #' + Inverte_Data_Plus(Trim(Data_Procura_Saida.Text),'amd','-') + '#)';
                 End
           ...
           Else
              ...
              Else If Trim(Opcoes_Procura_Servico.Text) = 'Cotação' Then
                 Begin
                 Comando_SQL       := 'Select * from Vendas_Manutencao, Clientes Where venda_manutencao_cliente_codigo = cliente_codigo And venda_manutencao_servico = ' + #39 + 'Cotação' + #39 + ' And (venda_manutencao_entrada >= #' + Inverte_Data_Plus(Trim(Data_Procura_Entrada.Text),'amd','-') + '# And venda_manutencao_entrada <= #' + Inverte_Data_Plus(Trim(Data_Procura_Saida.Text),'amd','-') + '#) And venda_manutencao_relacao_pecas Like ' + #39 + '%' + Trim(Dados_Procura.Text) + '%' + #39 + ' Order By venda_manutencao_entrada Desc';
                 Comando_SQL_Total := 'Select Sum(venda_manutencao_valor) as venda_manutencao_total from Vendas_Manutencao, Clientes Where venda_manutencao_cliente_codigo = cliente_codigo And venda_manutencao_servico = ' + #39 + 'Cotação' + #39 + ' And (venda_manutencao_entrada >= #' + Inverte_Data_Plus(Trim(Data_Procura_Entrada.Text),'amd','-') + '# And venda_manutencao_entrada <= #' + Inverte_Data_Plus(Trim(Data_Procura_Saida.Text),'amd','-') + '#) And venda_manutencao_relacao_pecas Like ' + #39 + '%' + Trim(Dados_Procura.Text) + '%' + #39;
                 End
              Else If Trim(Opcoes_Procura_Servico.Text) = 'Locação' Then
                 Begin
                 Comando_SQL       := 'Select * from Vendas_Manutencao, Clientes Where venda_manutencao_cliente_codigo = cliente_codigo And venda_manutencao_servico = ' + #39 + 'Locação' + #39 + ' And (venda_manutencao_entrada >= #' + Inverte_Data_Plus(Trim(Data_Procura_Entrada.Text),'amd','-') + '# And venda_manutencao_entrada <= #' + Inverte_Data_Plus(Trim(Data_Procura_Saida.Text),'amd','-') + '#) And venda_manutencao_relacao_pecas Like ' + #39 + '%' + Trim(Dados_Procura.Text) + '%' + #39 + ' Order By venda_manutencao_entrada Desc';
                 Comando_SQL_Total := 'Select Sum(venda_manutencao_valor) as venda_manutencao_total from Vendas_Manutencao, Clientes Where venda_manutencao_cliente_codigo = cliente_codigo And venda_manutencao_servico = ' + #39 + 'Locação' + #39 + ' And (venda_manutencao_entrada >= #' + Inverte_Data_Plus(Trim(Data_Procura_Entrada.Text),'amd','-') + '# And venda_manutencao_entrada <= #' + Inverte_Data_Plus(Trim(Data_Procura_Saida.Text),'amd','-') + '#) And venda_manutencao_relacao_pecas Like ' + #39 + '%' + Trim(Dados_Procura.Text) + '%' + #39;
                 End
              Else If Trim(Opcoes_Procura_Servico.Text) = 'Manutenção' Then
                 Begin
                 Comando_SQL       := 'Select * from Vendas_Manutencao, Clientes Where venda_manutencao_cliente_codigo = cliente_codigo And venda_manutencao_servico = ' + #39 + 'Manutenção' + #39 + ' And (venda_manutencao_entrada >= #' + Inverte_Data_Plus(Trim(Data_Procura_Entrada.Text),'amd','-') + '# And venda_manutencao_entrada <= #' + Inverte_Data_Plus(Trim(Data_Procura_Saida.Text),'amd','-') + '#) And venda_manutencao_relacao_pecas Like ' + #39 + '%' + Trim(Dados_Procura.Text) + '%' + #39 + ' Order By venda_manutencao_entrada Desc';
                 Comando_SQL_Total := 'Select Sum(venda_manutencao_valor) as venda_manutencao_total from Vendas_Manutencao, Clientes Where venda_manutencao_cliente_codigo = cliente_codigo And venda_manutencao_servico = ' + #39 + 'Manutenção' + #39 + ' And (venda_manutencao_entrada >= #' + Inverte_Data_Plus(Trim(Data_Procura_Entrada.Text),'amd','-') + '# And venda_manutencao_entrada <= #' + Inverte_Data_Plus(Trim(Data_Procura_Saida.Text),'amd','-') + '#) And venda_manutencao_relacao_pecas Like ' + #39 + '%' + Trim(Dados_Procura.Text) + '%' + #39;
                 End
              Else If Trim(Opcoes_Procura_Servico.Text) = 'Nota' Then
                 Begin
        ...
        Else
           ...
           If Trim(Dados_Procura.Text) = '' Then
              ...
              Else If Trim(Opcoes_Procura_Servico.Text) = 'Cotação' Then
                 Begin
                 Comando_SQL       := 'Select * from Vendas_Manutencao, Clientes Where venda_manutencao_cliente_codigo = cliente_codigo And venda_manutencao_servico = ' + #39 + 'Cotação' + #39 + ' And (venda_manutencao_saida >= #' + Inverte_Data_Plus(Trim(Data_Procura_Entrada.Text),'amd','-') + '# And venda_manutencao_saida <= #' + Inverte_Data_Plus(Trim(Data_Procura_Saida.Text),'amd','-') + '#) Order By venda_manutencao_saida Desc';
                 Comando_SQL_Total := 'Select Sum(venda_manutencao_valor) as venda_manutencao_total from Vendas_Manutencao, Clientes Where venda_manutencao_cliente_codigo = cliente_codigo And venda_manutencao_servico = ' + #39 + 'Cotação' + #39 + ' And (venda_manutencao_saida >= #' + Inverte_Data_Plus(Trim(Data_Procura_Entrada.Text),'amd','-') + '# And venda_manutencao_saida <= #' + Inverte_Data_Plus(Trim(Data_Procura_Saida.Text),'amd','-') + '#)';
                 End
              Else If Trim(Opcoes_Procura_Servico.Text) = 'Locação' Then
                 Begin
                 Comando_SQL       := 'Select * from Vendas_Manutencao, Clientes Where venda_manutencao_cliente_codigo = cliente_codigo And venda_manutencao_servico = ' + #39 + 'Locação' + #39 + ' And (venda_manutencao_saida >= #' + Inverte_Data_Plus(Trim(Data_Procura_Entrada.Text),'amd','-') + '# And venda_manutencao_saida <= #' + Inverte_Data_Plus(Trim(Data_Procura_Saida.Text),'amd','-') + '#) Order By venda_manutencao_saida Desc';
                 Comando_SQL_Total := 'Select Sum(venda_manutencao_valor) as venda_manutencao_total from Vendas_Manutencao, Clientes Where venda_manutencao_cliente_codigo = cliente_codigo And venda_manutencao_servico = ' + #39 + 'Locação' + #39 + ' And (venda_manutencao_saida >= #' + Inverte_Data_Plus(Trim(Data_Procura_Entrada.Text),'amd','-') + '# And venda_manutencao_saida <= #' + Inverte_Data_Plus(Trim(Data_Procura_Saida.Text),'amd','-') + '#)';
                 End
              Else If Trim(Opcoes_Procura_Servico.Text) = 'Manutenção' Then
                 Begin
                 ...
                 Comando_SQL_Total := 'Select Sum(venda_manutencao_valor) as venda_manutencao_total from Vendas_Manutencao, Clientes Where venda_manutencao_cliente_codigo = cliente_codigo And venda_manutencao_servico = ' + #39 + 'Manutenção' + #39 + ' And (venda_manutencao_saida >= #' + Inverte_Data_Plus(Trim(Data_Procura_Entrada.Text),'amd','-') + '# And venda_manutencao_saida <= #' + Inverte_Data_Plus(Trim(Data_Procura_Saida.Text),'amd','-') + '#)';
                 End
              Else If Trim(Opcoes_Procura_Servico.Text) = 'Nota' Then
                 Begin
...
begin
     ...
     RelEquipamentos01.lblPeriodo.Caption       := 'Período de ' + Trim(Data_Procura_Entrada.Text) + ' até ' + Trim(Data_Procura_Entrada.Text);
     RelEquipamentos01.lblTipoRelatorio.Caption := 'Serviço: ' + Trim(Opcoes_Procura_Servico.Text) + '        Data: ' + Trim(Opcoes_Procura_Data.Text);
