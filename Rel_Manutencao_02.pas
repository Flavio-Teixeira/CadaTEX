...
var
  RelManutencao02: TRelManutencao02;
...
function TRelManutencao02.Valida_Dados(): Boolean;
...
function TRelManutencao02.CurrText: TJvTextAttributes;
begin
     Result := Venda_Manutencao_Descricao.SelAttributes;
end;

procedure TRelManutencao02.FormCreate(Sender: TObject);
begin
     SetupRuler;
end;

procedure TRelManutencao02.BT_Edita_FonteClick(Sender: TObject);
begin
...
procedure TRelManutencao02.BT_Insere_ImagemClick(Sender: TObject);
...
procedure TRelManutencao02.BT_Insere_RtfClick(Sender: TObject);
begin
...
procedure TRelManutencao02.BT_Alinha_EsquerdaClick(Sender: TObject);
begin
     Venda_Manutencao_Descricao.Paragraph.Alignment := TParaAlignment(0); // paLeftJustify;
end;

procedure TRelManutencao02.BT_Alinha_CentroClick(Sender: TObject);
begin
     Venda_Manutencao_Descricao.Paragraph.Alignment := TParaAlignment(2); // paCenter
end;

procedure TRelManutencao02.BT_JustificaClick(Sender: TObject);
begin
     Venda_Manutencao_Descricao.Paragraph.Alignment := TParaAlignment(3); // paJustify;
end;

procedure TRelManutencao02.BT_Alinha_DireitaClick(Sender: TObject);
begin
     Venda_Manutencao_Descricao.Paragraph.Alignment := TParaAlignment(1); // paRightJustify
end;

procedure TRelManutencao02.BT_Inserir_MarcadoresClick(Sender: TObject);
begin
...
procedure TRelManutencao02.BT_Aumentar_RecuoClick(Sender: TObject);
begin
     Venda_Manutencao_Descricao.Paragraph.FirstIndent := Venda_Manutencao_Descricao.Paragraph.FirstIndent + 5;
end;

procedure TRelManutencao02.BT_Diminuir_RecuoClick(Sender: TObject);
begin
...
procedure TRelManutencao02.BT_ImprimirClick(Sender: TObject);
begin
...
procedure TRelManutencao02.SelectionChange(Sender: TObject);
begin
...
procedure TRelManutencao02.RulerResize(Sender: TObject);
begin
...
procedure TRelManutencao02.RulerItemMouseDown(Sender: TObject; Button: TMouseButton;
...
procedure TRelManutencao02.RulerItemMouseMove(Sender: TObject; Shift: TShiftState;
  X, Y: Integer);
begin
  if FDragging then
    TLabel(Sender).Left :=  TLabel(Sender).Left+X-FDragOfs
...
procedure TRelManutencao02.FirstIndMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  FDragging := False;
...
procedure TRelManutencao02.LeftIndMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  FDragging := False;
...
procedure TRelManutencao02.RightIndMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  FDragging := False;
...
procedure TRelManutencao02.Venda_Manutencao_DescricaoChange(Sender: TObject);
begin
  SetModified(Venda_Manutencao_Descricao.Modified);
end;

procedure TRelManutencao02.SetupRuler;
var
  I: Integer;
  S: String;
begin
...
procedure TRelManutencao02.UpdateCursorPos;
var
  CharPos: TPoint;
begin
...
procedure TRelManutencao02.SetModified(Value: Boolean);
begin
  if Value then StatusBar.Panels[1].Text := sModified
  else StatusBar.Panels[1].Text := '';
end;

procedure TRelManutencao02.BT_SairClick(Sender: TObject);
begin
     RelManutencao02.close;
end;

procedure TRelManutencao02.FormShow(Sender: TObject);
begin
     SetModified(False);
...
procedure TRelManutencao02.BT_AlterarClick(Sender: TObject);
...
procedure TRelManutencao02.Venda_Manutencao_ServicoKeyPress(
...
procedure TRelManutencao02.Venda_Manutencao_TipoKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRelManutencao02.Venda_Manutencao_EntradaKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRelManutencao02.Venda_Manutencao_SaidaKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRelManutencao02.Venda_Manutencao_Relacao_PecasKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRelManutencao02.Venda_Manutencao_ValorKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRelManutencao02.ImprimirClick(Sender: TObject);
...
procedure TRelManutencao02.Enviar_EmailClick(Sender: TObject);
...
procedure TRelManutencao02.Criar_RTF(Opcao: String);
...
procedure TRelManutencao02.BT_ExcluirClick(Sender: TObject);
begin
