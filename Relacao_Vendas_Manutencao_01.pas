unit Relacao_Vendas_Manutencao_01;
...
type
  TVendasManutencao01 = class(TForm)
    Panel1: TPanel;
    GroupBox1: TGroupBox;
    Label2: TLabel;
...
var
  VendasManutencao01: TVendasManutencao01;
...
function TVendasManutencao01.Valida_Dados(): Boolean;
...
function TVendasManutencao01.CurrText: TJvTextAttributes;
begin
     Result := Venda_Manutencao_Descricao.SelAttributes;
end;

procedure TVendasManutencao01.FormCreate(Sender: TObject);
begin
     SetupRuler;
end;

procedure TVendasManutencao01.BT_Edita_FonteClick(Sender: TObject);
begin
...
procedure TVendasManutencao01.BT_Insere_ImagemClick(Sender: TObject);
...
procedure TVendasManutencao01.BT_Insere_RtfClick(Sender: TObject);
begin
...
procedure TVendasManutencao01.BT_Alinha_EsquerdaClick(Sender: TObject);
begin
     Venda_Manutencao_Descricao.Paragraph.Alignment := TParaAlignment(0); // paLeftJustify;
end;

procedure TVendasManutencao01.BT_Alinha_CentroClick(Sender: TObject);
begin
     Venda_Manutencao_Descricao.Paragraph.Alignment := TParaAlignment(2); // paCenter
end;

procedure TVendasManutencao01.BT_JustificaClick(Sender: TObject);
begin
     Venda_Manutencao_Descricao.Paragraph.Alignment := TParaAlignment(3); // paJustify;
end;

procedure TVendasManutencao01.BT_Alinha_DireitaClick(Sender: TObject);
begin
     Venda_Manutencao_Descricao.Paragraph.Alignment := TParaAlignment(1); // paRightJustify
end;

procedure TVendasManutencao01.BT_Inserir_MarcadoresClick(Sender: TObject);
begin
...
procedure TVendasManutencao01.BT_Aumentar_RecuoClick(Sender: TObject);
begin
     Venda_Manutencao_Descricao.Paragraph.FirstIndent := Venda_Manutencao_Descricao.Paragraph.FirstIndent + 5;
end;

procedure TVendasManutencao01.BT_Diminuir_RecuoClick(Sender: TObject);
begin
...
procedure TVendasManutencao01.BT_ImprimirClick(Sender: TObject);
begin
...
procedure TVendasManutencao01.SelectionChange(Sender: TObject);
begin
...
procedure TVendasManutencao01.RulerResize(Sender: TObject);
begin
...
procedure TVendasManutencao01.RulerItemMouseDown(Sender: TObject; Button: TMouseButton;
...
procedure TVendasManutencao01.RulerItemMouseMove(Sender: TObject; Shift: TShiftState;
  X, Y: Integer);
begin
  if FDragging then
    TLabel(Sender).Left :=  TLabel(Sender).Left+X-FDragOfs
...
procedure TVendasManutencao01.FirstIndMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  FDragging := False;
...
procedure TVendasManutencao01.LeftIndMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  FDragging := False;
...
procedure TVendasManutencao01.RightIndMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  FDragging := False;
...
procedure TVendasManutencao01.Venda_Manutencao_DescricaoChange(Sender: TObject);
begin
  SetModified(Venda_Manutencao_Descricao.Modified);
end;

procedure TVendasManutencao01.SetupRuler;
var
  I: Integer;
  S: String;
begin
...
procedure TVendasManutencao01.UpdateCursorPos;
var
  CharPos: TPoint;
begin
...
procedure TVendasManutencao01.SetModified(Value: Boolean);
begin
  if Value then StatusBar.Panels[1].Text := sModified
  else StatusBar.Panels[1].Text := '';
end;

procedure TVendasManutencao01.BT_SairClick(Sender: TObject);
begin
     VendasManutencao01.close;
end;

procedure TVendasManutencao01.FormShow(Sender: TObject);
begin
     SetModified(False);
...
procedure TVendasManutencao01.BT_IncluirClick(Sender: TObject);
...
begin
     ...
     If  NroEquip <> 'duplicado' then
      Begin
        ...
        If Confirma('Incluir Outra Venda e Manutenção?') = 6 Then
           Begin
           Venda_Manutencao_Servico.ItemIndex    := 2;
...
procedure TVendasManutencao01.Venda_Manutencao_ServicoKeyPress(
...
procedure TVendasManutencao01.Venda_Manutencao_TipoKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TVendasManutencao01.Venda_Manutencao_EntradaKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TVendasManutencao01.Venda_Manutencao_SaidaKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TVendasManutencao01.Venda_Manutencao_Relacao_PecasKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TVendasManutencao01.Venda_Manutencao_ValorKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TVendasManutencao01.Venda_Manutencao_Nro_EquipamentoKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
